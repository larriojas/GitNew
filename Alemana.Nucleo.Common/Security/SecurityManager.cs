...
namespace Alemana.Nucleo.Common.Security
{
    public static class SecurityManager
    {
        ...
        private static void InitReleaseMode()
        {
            ...
            ComponentContainer.Instance.Register<IAuthenticationProvider, ActiveDirectorySecurityProvider>(true);
            ComponentContainer.Instance.Register<IAuthorizationProvider, Suser2AuthorizationProvider>(true);
            ComponentContainer.Instance.Register<IPasswordProvider, ActiveDirectorySecurityProvider>(true);
            ComponentContainer.Instance.Register<IAuditingProvider, NucleoAuditingProvider>(true);
        }
        ...
        private static void InitDebugMode()
        {
            ...
            if (MockAuthenticationEnabled)
            {
                ...
                {
                    ComponentContainer.Instance.Register<IAuthenticationProvider, MockSecurityProvider2>(true);
            ...
            {
                ComponentContainer.Instance.Register<IAuthorizationProvider, MockSecurityProvider>(true);
            ...
            {
                ComponentContainer.Instance.Register<IPasswordProvider, MockSecurityProvider>(true);
            ...
            {
                ComponentContainer.Instance.Register<IAuditingProvider, MockSecurityProvider>(true);
